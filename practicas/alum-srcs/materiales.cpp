...
MaterialPeonBlanco::MaterialPeonBlanco():Material(Tupla3f(0.9,0.9,0.9),0.5,0.4,0.5,10.0){
  ponerNombre("material peon blanco");
}

MaterialPeonNegro::MaterialPeonNegro():Material(Tupla3f(0.1,0.1,0.1),0.5,0.4,0.5,10.0){
...
MaterialPelota::MaterialPelota():Material(new TexturaXY("./text-marmol.jpg"),0.7,0.7,1.0,50.0){
...
ColeccionFuentesP4::ColeccionFuentesP4(){
  ...
  insertar(new FuenteDireccional(0.0,0.0,fuenteBlanca));
  //insertar(new FuentePosicional(Tupla3f{10.0,9.0,5.0},fuenteBlanca));
}
